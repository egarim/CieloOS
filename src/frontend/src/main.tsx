...
function App() {
  ...
  const [view, setView] = React.useState<"home" | "desk" | "models" | "people" | "activity" | "machine">("home");
      ...
      <div className="homeThings">
        <div className="cards">
          <button className="ex" onClick={onDesk}>
            ...
            <span className="t">Open the desktop</span>
            <span className="d">Watch the agent work, or take the screen yourself.</span>
          </button>
        </div>
      </div>
    </section>
